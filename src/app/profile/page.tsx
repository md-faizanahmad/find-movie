...
///////////////////////////////////////////////////////////////////////
import Link from "next/link";
import { Heart, Mail, ChevronRight } from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl px-5 py-8 md:px-8 md:py-12">
        ...
        <section className="border-b border-white/10 pb-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-red-500 text-xl font-semibold text-white">
        ...
        <section className="mt-10">
          <div className="mb-8 flex items-end justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-500">
                {favoriteItems.length} saved titles
              </p>
            </div>
          ...
          {favoriteItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <Link
                href="/"
                className="mt-6 text-sm font-medium text-red-500 hover:text-red-400"
              >
                Browse Content
              </Link>
            </div>
