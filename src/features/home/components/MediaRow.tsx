...
import { ProtectedMediaCard } from "./ProtectedMediaCard";
...
export function MediaRow({
  ...
  return (
    <>
      <section className="group/row px-6 py-6 md:px-8 md:py-12">
        {/* Header */}
        ...
        <div className="relative">
          ...
          <div
            ref={scrollRef}
            className="
              flex items-start gap-3 overflow-x-auto overflow-y-hidden px-4 py-6 scroll-smooth
            ...
            {items.map((item) => (
              ...
              >
                <ProtectedMediaCard
                  ...
                  isFavorited={false}
                  onRequireAuth={authModal.openModal}
                />
              </div>
            ))}
